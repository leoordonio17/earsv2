...
<div class="view-container">
    ...
    <div class="view-card">
        <div class="task-category-preview">
            <div class="task-category-preview-label">Task Category Preview</div>
            <div class="task-category-badge-large" style="background-color: <?= Html::encode($model->color) ?>;">
