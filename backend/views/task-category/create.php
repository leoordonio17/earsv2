...
<style>
    ...
    .field-taskcategory-is_active,
    .field-taskcategory-sort_order {
        width: 48%;
...
<div class="form-container">
    ...
    <div class="form-card">
        <?php $form = ActiveForm::begin([
            ...
            'options' => ['class' => 'task-category-form'],
            'fieldConfig' => [
                'template' => "{label}\n{input}\n{error}",
        ...
        <?= $form->field($model, 'task_type_id')->dropDownList(
            TaskType::getDropdownList(),
            [
                'prompt' => 'Select Task Type',
                'class' => 'form-control',
            ]
        )->label('Task Type <span style="color: #e74c3c;">*</span>', ['encode' => false]) ?>

        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Enter category name']) ?>

        <?= $form->field($model, 'description')->textarea(['rows' => 4, 'placeholder' => 'Enter category description (optional)']) ?>

        <div class="form-group field-taskcategory-color">
        ...
        <div class="form-group field-taskcategory-sort_order">
        ...
        <div class="form-group field-taskcategory-is_active">
        ...
        <div class="form-actions">
            ...
            <?= Html::submitButton('Create Task Category', ['class' => 'btn-submit']) ?>
        </div>
