...
<div class="view-container">
    ...
    <div class="view-card">
        <div class="milestone-preview">
            <div class="milestone-preview-label">Milestone Preview</div>
            <div class="milestone-badge-large" style="background-color: <?= Html::encode($model->color) ?>;">
