...
<div class="view-container">
    ...
    <div class="view-card">
        <div class="project-stage-preview">
            <div class="project-stage-preview-label">Project Stage Preview</div>
            <div class="project-stage-badge-large" style="background-color: <?= Html::encode($model->color) ?>;">
