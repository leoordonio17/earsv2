...
/* @var $model common\models\ProjectStage */

$this->title = 'Update Project Stage: ' . $model->name;
?>
<style>
    .form-container {
        padding: 30px;
    ...
    .field-projectstage-is_active,
    .field-projectstage-sort_order {
        width: 48%;
...
<div class="form-container">
    ...
    <div class="form-card">
        <?php $form = ActiveForm::begin([
            ...
            'options' => ['class' => 'project-stage-form'],
            'fieldConfig' => [
                'template' => "{label}\n{input}\n{error}",
        ...
        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Enter project stage name']) ?>

        <?= $form->field($model, 'description')->textarea(['rows' => 4, 'placeholder' => 'Enter project stage description (optional)']) ?>

        <div class="form-group field-projectstage-color">
        ...
        <div class="form-group field-projectstage-sort_order">
        ...
        <div class="form-group field-projectstage-is_active">
        ...
        <div class="form-actions">
            ...
            <?= Html::submitButton('Update Project Stage', ['class' => 'btn-submit']) ?>
        </div>
