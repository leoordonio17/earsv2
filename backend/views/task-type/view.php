...
<div class="view-container">
    ...
    <div class="view-card">
        <div class="task-type-preview">
            <div class="task-type-preview-label">Task Type Preview</div>
            <div class="task-type-badge-large" style="background-color: <?= Html::encode($model->color) ?>;">
