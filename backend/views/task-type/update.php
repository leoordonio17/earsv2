...
<style>
    ...
    .field-tasktype-is_active,
    .field-tasktype-sort_order {
        width: 48%;
...
<div class="form-container">
    ...
    <div class="form-card">
        ...
        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Enter task type name']) ?>

        <?= $form->field($model, 'description')->textarea(['rows' => 4, 'placeholder' => 'Enter task type description (optional)']) ?>

        <div class="form-group field-tasktype-color">
        ...
        <div class="form-group field-tasktype-sort_order">
        ...
        <div class="form-group field-tasktype-is_active">
        ...
        <div class="form-actions">
            ...
            <?= Html::submitButton('Update Task Type', ['class' => 'btn-submit']) ?>
        </div>
