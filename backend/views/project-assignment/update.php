...
use common\models\ProjectAssignment;use kartik\select2\Select2;
/* @var $this yii\web\View */
/* @var $model common\models\ProjectAssignment */

$this->title = 'Update Project Assignment: ' . $model->project_name;
?>
<style>
    .form-container {
        padding: 30px;
...
<div class="form-container">
    ...
    <div class="form-card">
        ...
        <div class="form-group field-projectassignment-project_id">
            ...
            <?php 
            $projects = ProjectAssignment::fetchProjectsFromAPI();
            ?>
            <?= Html::dropDownList('project_dropdown', $model->project_id, $projects, [
                'id' => 'project-dropdown',
                'class' => 'form-control',
                'disabled' => true,
                'style' => 'background-color: #f5f5f5; cursor: not-allowed; opacity: 0.7;',
            ]) ?>
            <small style="color: #967259; display: block; margin-top: 5px; font-style: italic;">
                Project cannot be changed when editing. Delete and create new assignment to change project.
            </small>
            <?= $form->field($model, 'project_id')->hiddenInput(['id' => 'project-id-hidden', 'value' => $model->project_id])->label(false) ?>
            <?= $form->field($model, 'project_name')->hiddenInput(['id' => 'project-name-hidden', 'value' => $model->project_name])->label(false) ?>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= Html::submitButton('Update Project Assignment', ['class' => 'btn-submit']) ?>
        </div>
