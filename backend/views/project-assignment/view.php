...
<style>
    ...
    .project-assignment-preview-label {
        color: #967259;
        font-size: 13px;
        font-weight: 600;
    ...
    .project-assignment-badge-large {
        display: inline-flex;
        align-items: center;
        gap: 12px;
        padding: 16px 32px;
...
<div class="view-container">
    <div class="view-header">
        ...
        <div class="header-actions">
            ...
            <?= Html::a('<span>🗑</span> Delete', ['delete', 'id' => $model->id], [
                'class' => 'btn-delete',
                'data' => [
                    'confirm' => 'Are you sure you want to delete this project assignment?',
                    'method' => 'post',
                ],
            ]) ?>
        </div>
    ...
    <div class="view-card">
        <div class="project-assignment-preview">
            <div class="project-assignment-preview-label">Project Assignment Preview</div>
            <div class="project-assignment-badge-large">
        ...
        <table class="detail-table">
            ...
            <tr>
                <th>Project Name</th>
                <td><strong style="font-size: 18px;"><?= Html::encode($model->project_name ?: 'N/A') ?></strong></td>
            </tr>
            <tr>
                <th>Project ID</th>
                <td><?= Html::encode($model->project_id ?: 'N/A') ?></td>
            </tr>
            <tr>
                <th>Researcher</th>
                <td><strong style="font-size: 18px;"><?= Html::encode($model->user ? $model->user->full_name : 'N/A') ?></strong></td>
            </tr>
            <tr>
                <th>Researcher Email</th>
                <td><?= Html::encode($model->user ? $model->user->email : 'N/A') ?></td>
            </tr>
            <tr>
                <th>Created At</th>
