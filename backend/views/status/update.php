...
<div class="form-container">
    ...
    <div class="form-card">
        ...
        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Enter status name']) ?>

        <?= $form->field($model, 'description')->textarea(['rows' => 4, 'placeholder' => 'Enter status description (optional)']) ?>

        <div class="form-group field-status-color">
        ...
        <div class="form-group field-status-sort_order">
        ...
        <div class="form-group field-status-is_active">
        ...
        <div class="form-actions">
            ...
            <?= Html::submitButton('Update Status', ['class' => 'btn-submit']) ?>
        </div>
